...
export default function Roadmap() {
  ...
  return (
    <>
      <div className="relative flex flex-col items-center justify-center bg-primary px-4 pb-20 pt-16 text-white">
        <Image
        ...
        <div
          ...
          onScroll={e => {
            if (e.currentTarget.scrollLeft > 730 && showHand) setShowHand(false)
            if (e.currentTarget.scrollLeft < 730 && !showHand) setShowHand(true)
          }}
        >
        ...
        <Image
          ...
          alt="hand"
          className={cn(
            'origin-bottom-center animate-hand-rotate transition-all duration-300',
            showHand ? 'opacity-100' : 'opacity-0',
          )}
        />
        <InvestButton className="mt-10" />
      </div>
      <Image
