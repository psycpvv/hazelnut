    ...
    <div className="px-4 py-14">
      <div className="flex flex-col gap-4 px-4 pb-12 text-center">
        ...
        <Typography variant="subtitle1">
          ...
          agricultural sector. We are committed to providing our customers with
          easy and simple access to the agri asset class, as well as the
      ...
      <div className="flex flex-col gap-3">
        <div className="flex gap-2.5 text-base/6 items-first-baseline">
          ...
          <div>10,000 ha intensive high-yield hazelnut orchards developed</div>
        </div>
        <div className="flex gap-2.5 text-base/6 items-first-baseline">
          <div>
            <FontAwesomeIcon
